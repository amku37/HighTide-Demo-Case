...
const int LED_BRIGHTNESS   = 250;      // Master brightness (0-255)
const unsigned long TANK_CAPACITY = 50000; // Capacity in Gallons
const int PUMP_FLOW_SINGLE = 550;      // GPM for one pump
const int PUMP_FLOW_DUAL   = 490;      // GPM per pump when both run (friction loss)
const int PUMP_AMPS_SINGLE = 80;       // Simulated Amps
...
// --- GLOBAL VARIABLES ---
float currentGallons = 35000;  // Current water volume
